 ...
 */
public class ThursdayFragment extends BaseBroadcastFragment {
    private final static String TAG = ThursdayFragment.class.getSimpleName();
    ...
    public void onEvent(SimpleEvent event) {/* Do something */
        if (event.getMsg() == Constants.THURSDAY) {
