...
public class AddFliActivity extends Activity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.add_transfer:
                if (mTransfersList.size() <= 1) {
                    ...
                    Toast.makeText(AddFliActivity.this, "暂时支持两个经停站", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.header_right_btn:
                ...
                if (new AddFliDataControl().checkText(mHeadViewList) && new AddFliDataControl().checkText(mBodyViewList)) {
                    ...
                    Toast.makeText(AddFliActivity.this, "航班信息不可为空", Toast.LENGTH_LONG).show();
                }
                break;
    ...
    private void showDialogFragment(final FlightInfo flightInfo) {
        ...
        simpleDialogFragment.setOnButtonClickListener(new IDialogFragment() {
            ...
            public void onDialogFragmentButtonClickListener() {
                ...
                FlightInfoTemp flightInfoTemp = DBManager.getInstance(AddFliActivity.this).queryByFlightInfoPid(flightInfo.getId());
                ...
                DBManager.getInstance(AddFliActivity.this).insert(historyFlightTempEdit, DBManager.getInstance(AddFliActivity.this).getHistoryFlightTempEditDao(DBManager.WRITE_ONLY));
    ...
    private void initViews(Bundle savedInstanceState) {
        ...
        right_btn = (TextView) findViewById(R.id.header_right_btn);
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            if (title.equals(titles1[1])) {
                ...
                lineView.getEditText().setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Calendar c = Calendar.getInstance();
                        Dialog dialog = new DatePickerDialog(AddFliActivity.this,
