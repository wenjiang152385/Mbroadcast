 ...
 */
public abstract class BaseListAdapter<T extends FlightInfoTemp> extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int type) {
        switch (type) {
            ...
            case VIEW_TYPE_FOOTER:
                return new FooterViewHolder(mInflater.inflate(R.layout.list_footer1, parent, false));
            default:
