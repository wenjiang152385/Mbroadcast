...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    private static final int FOOTER_COLOR = 0xFFF5A623;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path.moveTo(left_x - top_y + 80, top_y + 1f);
        path.lineTo(right_x - top_y, top_y + 1f);
        path.lineTo(right_x - bottom_y, bottom_y + 1f);
        path.lineTo(left_x - top_y + 80, bottom_y + 1f);
        path.close();
