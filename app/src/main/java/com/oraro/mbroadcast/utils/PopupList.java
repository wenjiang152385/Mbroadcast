...
//                mRawY =event.getRawY()-100;
    ...
    private void showPopupListWindow() {
        ...
        mPopupWindow.showAsDropDown(mContextView,mContextView.getWidth()/2 - height/2 ,-height*2);
...
//        Log.e("Poplist","  mPopupWindow x " +(mRawY -80- mScreenHeight / 2 - mPopupWindowHeight + mIndicatorHeight));
//        Log.e("Poplist","  mRawY  "+mRawY);
//        Log.e("Poplist","  mScreenHeight/2  "+mScreenHeight / 2);
//        Log.e("Poplist","  mPopupWindowHeight  "+mPopupWindowHeight );
//        Log.e("Poplist","  mIndicatorHeight  "+mIndicatorHeight );
