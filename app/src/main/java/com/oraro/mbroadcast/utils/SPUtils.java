...
/**
 * Created by dongyu on 2016/8/25 0025.
 */
public class SPUtils {
    ...
    public static Set getPrefStringSet(Context context, final String key,
    ...
    public static int getBroadcastNumber(Context context){
        return getPrefInt(context,"BroadcastNumber",3);
    }

    public static void setBroadcastNumber(Context context,int value){
        setPrefInt(context,"BroadcastNumber",value);
    }
